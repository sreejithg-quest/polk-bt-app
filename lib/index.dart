// Export pages
export '/pages/polk_b_t/sound_adjustments/sound_adjustments_widget.dart'
    show SoundAdjustmentsWidget;
export '/setup_assist/eula/eula_widget.dart' show EulaWidget;
export '/setup_assist/select_device/select_device_widget.dart'
    show SelectDeviceWidget;
export '/setup_assist/select_device_b_t/select_device_b_t_widget.dart'
    show SelectDeviceBTWidget;
...
export '/setup_assist/name_device/name_device_widget.dart'
    show NameDeviceWidget;
export '/setup_assist/registration/registration_widget.dart'
